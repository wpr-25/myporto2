    ...
    <div className="container px-6 py-8 mx-auto">
        ...
        <div className="flex flex-col items-center sm:flex-row sm:justify-between">
            ...
            <div class="flex mt-3 -mx-2 sm:mt-0">
                <Link href="https://portofolio1-beta.vercel.app/" class="mx-2 text-sm text-gray-500 transition-colors duration-300 hover:text-gray-500 dark:hover:text-gray-300" aria-label="Reddit"> Portofolio1 </Link>

                <Link href="/" className="mx-2 text-sm text-gray-500 transition-colors duration-300 hover:text-gray-500 dark:hover:text-gray-300" aria-label="Reddit"> Instagram </Link>

                <Link href="https://www.researchgate.net/publication/367595708_ANALISIS_BEHAVIOR_INTENTION_TERHADAP_KEEFEKTIFAN_MEDIA_PROMOSI_DIGITAL_MENGGUNAKAN_AUGMENTED_REALITY" class="mx-2 text-sm text-gray-500 transition-colors duration-300 hover:text-gray-500 dark:hover:text-gray-300" aria-label="Reddit"> Profile </Link>
            </div>
        </div>
    </div>
</footer>
